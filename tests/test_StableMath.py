...
class TestStableMath(unittest.TestCase):
    ...
    def test_calculate_invariants(self):
        '''
        Tests for instance of Decimal
        '''
        amp = Decimal(100)
        balances = [Decimal(10),Decimal(12)]
        result =  StableMath.calculate_invariant(amp, balances)
    ...
    def test_calc_in_given_out(stablemath_test):
       #TODO assert StableMath.calc_in_given_out(2,[222,3112,311],1,1,4) == 0.000002756210410895
        '''
        Tests for instance of Decimal
        '''
        amp = Decimal(100)
        ...
        result = StableMath.calc_in_given_out(amp, balances, tokenIndexIn, tokenIndexOut, tokenAmountOut)
        assert isinstance(result, Decimal)
        '''
    ...
    def test_calc_out_given_in(stablemath_test):
        #    def calc_out_given_in(amplificationParameter: Decimal, balances: list[Decimal], tokenIndexIn: int, tokenIndexOut: int, tokenAmountIn: Decimal):
        amp = Decimal(10)
        balances = [Decimal(10), Decimal(11), Decimal(12)]
        tokenIndexIn = 0
        tokenIndexOut = 1
        tokenAmountIn = Decimal(1)
        result = StableMath.calc_out_given_in(amp, balances, tokenIndexIn, tokenIndexOut, tokenAmountIn)
        assert isinstance(result, Decimal)
        '''
    ...
    def test_calc_bpt_out_given_exact_tokens_in(stablemath_test):
        '''
        Tests for instance of Decimal
        '''
        amp = Decimal(22)
        ...
        result = StableMath.calc_bpt_out_given_exact_tokens_in(amp, balances, amountsIn,bptTotalsupply, swapFee,swapFeePercentage)
        assert isinstance(result, Decimal)
        '''
        '''
    ...
    def test_calcTokenInGivenExactBptOut(stablemath_test):
        ...
        result = StableMath.calc_bpt_in_given_exact_tokens_out(amp, 
                                                balances,
                                                amountsOut,
                                                bptTotalSupply,
    ...
    def test_calcTokenOutGivenExactBptIn(stablemath_test):
        ...
        result = StableMath.calc_tokens_out_given_exact_bpt_in(balances,bptAmountIn, bptTotalSupply)
        assert isinstance(result, list)

    def test_calc_tokens_out_given_exact_bpt_in(stablemath_test):
        balances = [Decimal(10),Decimal(11)]
        bptAmountIn = Decimal(10)
        bptTotalSupply =Decimal(2)
        result = StableMath.calc_tokens_out_given_exact_bpt_in(balances,bptAmountIn,bptTotalSupply)
    ...
    def test_get_token_balance_given_invariant_and_all_other_balances(stablemath_test):

        # assert StableMath.get_token_balance_given_invariant_and_all_other_balances(22, [2,3,4,20], 1, 2) == 0.002573235526125192

        # self.assertAlmostEqual(
        #     StableMath.get_token_balance_given_invariant_and_all_other_balances(
        #         Decimal(22),
        ...
        assert isinstance(StableMath.get_token_balance_given_invariant_and_all_other_balances(
            Decimal(22),
            [Decimal(2),Decimal(3),Decimal(4),Decimal(20)],
            Decimal(1),
            2), Decimal)
        ...
        result = StableMath.get_token_balance_given_invariant_and_all_other_balances(amp, balances, invariant, tokenIndex)
