...
library FixedPoint {
    ...
    function _mulDown(uint256 a, uint256 b) external pure returns (uint256) {
        uint256 product = a * b;
        _require(a == 0 || product / a == b, Errors.MUL_OVERFLOW);
    ...
    function _mulUp(uint256 a, uint256 b) external pure returns (uint256) {
        uint256 product = a * b;
        _require(a == 0 || product / a == b, Errors.MUL_OVERFLOW);
    ...
    function _divDown(uint256 a, uint256 b) external pure returns (uint256) {
        _require(b != 0, Errors.ZERO_DIVISION);
    ...
    function _divUp(uint256 a, uint256 b) external pure returns (uint256) {
        _require(b != 0, Errors.ZERO_DIVISION);
...
function getTokenBalanceGivenInvariantAndAllOtherBalances(
    ...
    function juan(uint256 a, uint256 b) external pure returns (uint256) {
        uint256 result = a / b; 
    }
